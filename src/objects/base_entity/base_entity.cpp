...
Base_Entity::Base_Entity(str n, str ln, const int id) : name(std::move(n)), long_name(std::move(ln)), entity_id(id) {}
...
[[nodiscard]] str Base_Entity::to_string() const { return to_string("Base_Entity"); }
